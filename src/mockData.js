...
export const REBALANCING_RECS = [
  ...
  },
  {
    ...
    reasoning: "Pallet Pick is 2.2 h short with Sara O'Brien absent. Ben Okafor has 4 months Pallet Pick experience and Unit Sorter has a 9.6 h surplus that can absorb the reallocation.",
    impact: 'Closes the Pallet Pick 2.2 h gap for current shift',
  },
]
