...
export const DC_MANAGER_DATA = {
  ...
  contributorDetail: {
    inboundVariability: {
      ...
      avgVariance: 8.7,
      trend: 'up',
      // 5-period window: last 3 days, today, tomorrow
      chartData: [
        { label: '3 days ago', dayLabel: 'Mon',  conveyor: 51, pallet: 34, flat: 15, laborHours: { planned: 38, actual: 41 } },
        { label: '2 days ago', dayLabel: 'Tue',  conveyor: 44, pallet: 38, flat: 18, laborHours: { planned: 40, actual: 43 } },
        { label: 'Yesterday',  dayLabel: 'Wed',  conveyor: 57, pallet: 26, flat: 17, laborHours: { planned: 36, actual: 39 } },
        { label: 'Today',      dayLabel: 'Thu',  conveyor: 68, pallet: 18, flat: 14, laborHours: { planned: 42, actual: 49 } },
        { label: 'Tomorrow',   dayLabel: 'Fri',  conveyor: 55, pallet: 25, flat: 20, laborHours: { planned: 44, actual: null } },
      ],
      impactPct: 53,
      impactDollars: 18000,
    },
...
export const SHIFT_HANDOVER_REPORTS = [
  {
    id: 'HR-001',
    date: '2026-03-10',
    shift: 'AM',
    supervisor: 'Sandra Reyes',
    submitted: true,
    locked: true,
    lockedAt: '2026-03-10T23:00:00Z',
    paragraphs: [
      'Shift executed 97 units against a plan of 95 units. Inbound variability was low with steady conveyor traffic. The Unit Sorter ran without interruption. All labor staffing remained at full capacity with no absenteeism.',
      'Truck TR-01 to Atlanta departed on schedule at 06:00 AM. Machine downtime was minimal at 4 minutes for a routine belt inspection on US-1. The incoming PM shift will see increased pressure from an unexpected container batch arriving at 14:00.',
    ],
    kpis: {
      otif: 97.8,
      absenteeism: 0,
    ...
    extraCards: [
      {
        ...
        sorterIds: ['US-1'],
        reason: 'Routine belt inspection',
        startedAt: '08:15',
        resolvedAt: '08:19',
        impactMinutes: 4,
      },
  ...
  },
  {
    ...
    lockedAt: '2026-03-10T23:00:00Z',
    paragraphs: [
      'Challenging shift due to the unexpected container batch. Executed 88 units against a plan of 92 units, resulting in a modest OTIF miss of 96.2%. Labor experienced a 6% absenteeism rate with two call-outs in the Cart Pick zone. The team worked efficiently despite staffing constraints.',
      'Unit Sorter encountered a conveyor jam at 17:30 that required 28 minutes to clear. No damage to the machine. We managed to recover most of the backlog by end of shift. The incoming Night shift will need to address the remaining 12 units of overflow and monitor for similar issues.',
    ],
    kpis: {
      otif: 96.2,
      absenteeism: 6.0,
    ...
    extraCards: [
      ...
      },
      {
        ...
        workers: [
          { name: 'Lisa Chen', zone: 'Cart Pick', reason: 'Call-out' },
          { name: 'James Rodriguez', zone: 'Cart Pick', reason: 'Call-out' },
        ],
      },
    ],
  },
  {
    ...
    submitted: true,
    locked: true,
    lockedAt: '2026-03-11T23:00:00Z',
    paragraphs: [
      'Steady Night shift with strong focus on clearing the PM overflow. Executed 98 units against a plan of 90 units, exceeding target by 9% and achieving 99.1% OTIF. All staffing positions were filled with experienced operators. No absenteeism reported.',
      'Inbound traffic was lighter than expected, which allowed the team to focus on clearing backlogs. The Unit Sorter ran flawlessly throughout the shift with zero downtime. All trucks departed on schedule. The AM shift should see normal staffing and moderate workload.',
    ],
    kpis: {
      otif: 99.1,
      absenteeism: 0,
    ...
    extraCards: [
      {
        ...
        departures: [
          { truckId: 'TR-02', planned: '22:00', actual: '22:00', delta: 0 },
          { truckId: 'TR-03', planned: '04:30', actual: '04:30', delta: 0 },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    submitted: true,
    locked: true,
    lockedAt: '2026-03-07T23:00:00Z',
    paragraphs: [
      'Solid Saturday AM shift with steady throughput. Executed 94 units against a plan of 93 units for 98.9% OTIF. All staffing positions filled with full capacity.',
      'Inbound traffic was moderate and well-distributed across zones. Unit Sorter ran smoothly with minimal maintenance needs. Truck TR-10 to San Francisco departed on schedule.',
    ],
    kpis: {
      otif: 98.9,
      absenteeism: 0,
  ...
  },
  {
    ...
    lockedAt: '2026-03-07T23:00:00Z',
    paragraphs: [
      'Saturday PM shift handled moderately elevated traffic with good execution. Executed 87 units against a plan of 85 units for 97.6% OTIF. Labor staffing at 95% capacity with one minor delay.',
      'Inbound conveyor maintained steady flow. No major equipment issues. One truck departure delayed by 4 minutes but no cascade impact.',
    ],
    kpis: {
      otif: 97.6,
      absenteeism: 2.0,
  ...
  },
  {
    ...
    lockedAt: '2026-03-07T23:00:00Z',
    paragraphs: [
      'Night shift cleared Saturday workload efficiently. Executed 92 units against a plan of 88 units for 98.2% OTIF. Team maintained focus despite reduced staffing complement.',
      'Inbound traffic lighter than expected. Unit Sorter maintained steady performance. All truck departures on time.',
    ],
    kpis: {
      otif: 98.2,
      absenteeism: 1.5,
  ...
  },
  {
    ...
    submitted: true,
    locked: true,
    lockedAt: '2026-03-08T23:00:00Z',
    paragraphs: [
      'Sunday AM shift began week with strong metrics. Executed 96 units against a plan of 94 units for 99.2% OTIF. Full staffing complement at start of week.',
      'Inbound mix balanced across all container types. Unit Sorter ran without downtime. Standard maintenance window scheduled for next week.',
    ],
    kpis: {
      otif: 99.2,
      absenteeism: 0,
  ...
  },
  {
    ...
    lockedAt: '2026-03-08T23:00:00Z',
    paragraphs: [
      'Sunday PM shift managed incoming volume surge well. Executed 89 units against a plan of 87 units for 97.1% OTIF. One staff call-out managed through cross-zone coverage.',
      'Pallet container volume increased from 15:00 onwards. Team adapted efficiently. Minor conveyor adjustment needed at 16:45 resolved within 12 minutes.',
    ],
    kpis: {
      otif: 97.1,
      absenteeism: 3.5,
  ...
  },
  {
    ...
    lockedAt: '2026-03-08T23:00:00Z',
    paragraphs: [
      'Night shift successfully cleared PM overflow backlog. Executed 95 units against a plan of 91 units for 98.7% OTIF. Experienced team minimized downtime.',
      'Traffic patterns normalized by 22:00. All trucks scheduled for early morning loaded and ready. Shift readied facility for Monday operations.',
    ],
    kpis: {
      otif: 98.7,
      absenteeism: 0,
  ...
  },
  {
    ...
    submitted: true,
    locked: true,
    lockedAt: '2026-03-09T23:00:00Z',
    paragraphs: [
      'Monday AM shift kicked off strong week. Executed 95 units against a plan of 94 units for 98.1% OTIF. Full staffing with high engagement.',
      'Inbound variability low with steady mix. Unit Sorter maintenance completed ahead of schedule. Truck TR-11 to Memphis departed 3 minutes early.',
    ],
    kpis: {
      otif: 98.1,
      absenteeism: 0,
  ...
  },
  {
    ...
    lockedAt: '2026-03-09T23:00:00Z',
    paragraphs: [
      'Monday PM shift handled mid-week volume surge. Executed 90 units against a plan of 89 units for 96.8% OTIF. Two staff absences managed with acceptable impact.',
      'Conveyor zone B experienced brief 8-minute stoppage at 15:20 due to sensor drift. Resolved quickly with recalibration.',
    ],
    kpis: {
      otif: 96.8,
      absenteeism: 5.0,
  ...
  },
  {
    ...
    lockedAt: '2026-03-09T23:00:00Z',
    paragraphs: [
      'Night crew processed incoming backlog efficiently despite staffing constraints. Executed 94 units against a plan of 88 units for 99.0% OTIF.',
      'Unit Sorter maintained performance throughout. All outbound trucks loaded and departed on schedule. Ready for Tuesday AM.',
    ],
    kpis: {
      otif: 99.0,
      absenteeism: 2.5,
  ...
  },
  {
    ...
    lockedAt: '2026-03-10T23:00:00Z',
    paragraphs: [
      'Tuesday Night shift recovered from PM overflow challenge. Executed 96 units against a plan of 90 units for 97.8% OTIF. Strong focus on backlog clearance.',
      'Unit Sorter performed reliably. All contingency trucks loaded by 04:00. Shift prepared facility for Wednesday morning push.',
    ],
    kpis: {
      otif: 97.8,
      absenteeism: 1.0,
  ...
  },
  {
    ...
    lockedAt: '2026-03-11T23:00:00Z',
    paragraphs: [
      'Wednesday AM shift began final full day with high targets. Executed 97 units against a plan of 96 units for 98.4% OTIF. Full staffing and strong execution.',
      'Inbound conveyor steady. All cart picks on schedule. Unit Sorter running at peak efficiency. Truck TR-12 departed 2 minutes early.',
    ],
    kpis: {
      otif: 98.4,
      absenteeism: 0,
  ...
  },
  {
    ...
    lockedAt: '2026-03-11T23:00:00Z',
    paragraphs: [
      'Wednesday PM shift concluded strong week with excellent results. Executed 91 units against a plan of 90 units for 98.9% OTIF. All staffing positions filled.',
      'Final push managed efficiently with focus on quality. All trucks loaded with precision. Facility ready for Thursday continuation with draft shift ahead.',
    ],
    kpis: {
      otif: 98.9,
      absenteeism: 0,
